...
import { Columns3, Grid2X2, Search, SlidersHorizontal } from "lucide-react";
...
export function GalleryToolbar({ search, view, onSearchChange, onViewChange, onOpenFilters }: GalleryToolbarProps) {
  return (
